 ...
 */
void dlist_add_front(struct dlist *l, char *string);
 ...
 * @param ptr pointer to generic data to store in new list node
 */
void dlist_add_back(struct dlist *l, char *string);
...
char *dlist_read_back(struct dlist *l);

void *dlist_find_remove(struct dlist *l, char *string);

/**
 * Returns the size of the given pointer.
 *
 * @param l pointer to the list (non_NULL)
 * @param ptr pointer to the data item to be found
 * @return size of pointer found in node
 */
